---
title: 'Agent 的退潮线：Pi、DeepSeek Harness 与 AI 时代的护城河'
...
![Databricks 编码任务成本与通过率基准](/images/posts/pi-deepseek-harness-20260819/01-databricks-benchmark.png)
...
![Pi 与其他 Agent 的性能对照](/images/posts/pi-deepseek-harness-20260819/02-agent-comparison.png)
...
![Pi 源码结构分析](/images/posts/pi-deepseek-harness-20260819/03-pi-source-overview.png)
...
![Pi 系统提示词长度](/images/posts/pi-deepseek-harness-20260819/04-pi-system-prompt.png)
...
![每次请求的固定 token 开销](/images/posts/pi-deepseek-harness-20260819/05-fixed-request-overhead.png)
...
![关于上下文长度的讨论截图](/images/posts/pi-deepseek-harness-20260819/06-context-screenshot.jpg)
...
![Pi 的 agent loop](/images/posts/pi-deepseek-harness-20260819/07-pi-agent-loop.png)
...
![Pi、Claude Code 与 Codex 的对照](/images/posts/pi-deepseek-harness-20260819/08-harness-comparison.png)
...
![DeepSeek Harness 的插件结构](/images/posts/pi-deepseek-harness-20260819/09-deepseek-plugin-architecture.png)
...
![上下文处理的三道闸](/images/posts/pi-deepseek-harness-20260819/10-context-gates.png)
...
![DeepSeek Harness 的结构示意](/images/posts/pi-deepseek-harness-20260819/11-deepseek-harness-structure.png)
...
![Agent 脚手架的退潮](/images/posts/pi-deepseek-harness-20260819/12-scaffolding-tide.png)
...
![AI 产品与数据护城河](/images/posts/pi-deepseek-harness-20260819/13-data-moat.png)

![AI 产品与数据护城河（局部）](/images/posts/pi-deepseek-harness-20260819/14-data-moat-detail.png)
